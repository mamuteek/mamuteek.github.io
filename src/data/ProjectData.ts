export default class ProjectData {
    ...
    backgroundPosition: string; // custom background position for thumbnail

    constructor(id: string, name: string, iconUrl: string, html: string, accentColor = "#000000", isHigh = false, isWide = false, backgroundPosition = "center") {
        this.id = id;
        this.name = name;
